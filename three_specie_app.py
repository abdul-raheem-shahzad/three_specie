...
# Run the app
    ...
    # Picture
        st.image('one_specie.jpeg', caption='', use_column_width=True)
        ...
        #Pciture
        st.image('one_specie.jpeg', caption='Halodule Pinfolia', use_column_width=True)
...
#Thalassia
    ...
    #Pciture
        st.image('one_specie.jpeg', caption='testing', use_column_width=True)
